...
list_of_files=[
    ...
    f"{ROOT_FOLDER}/YAML_FILES/__init__.py",
    f"{ROOT_FOLDER}/YAML_FILES/config.yaml",
    ...
    f"{ROOT_FOLDER}/EXCEPTIONS/exceptions.py",
    f"{ROOT_FOLDER}/COMMON_METHODS/__init__.py",
    f"{ROOT_FOLDER}/COMMON_METHODS/COMMON_METHODS.py",
